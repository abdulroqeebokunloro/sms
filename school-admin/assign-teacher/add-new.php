<div class="col-md-6 col-md-offset-3">
	...
	<form action="" method="post">
		<div class="form-group">
			...
			<select name="global_name_id" id="global_name_id" class="form-control">
		...
		<div class="form-group">
			...
			<select name="subject_name_id" id="" class="form-control">
				<?php
		...
		<div class="form-group">
			...
			<select name="teacher_email" id="teacher_email" class="form-control">
				<?php
	...
	$(document).ready(function() {	
		...
		$(document).on('change', '#class_time, #teacher_email', function() {
			...
			if(class_time != '' && teacher_email != '') {
				$.ajax({
					url: 'assign-teacher/get_weekdays_fields.php',
					type: 'POST',
		...
		$(document).on('change', '#global_name_id', function() {
			...
			$.ajax({
				url: 'assign-teacher/class_time_validator.php',
				type: 'POST',
